...
entry:
  ...
  %call_tmp = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 %0)
  %sub_tmp = fsub float 3.000000e+00, 4.000000e+00
  %1 = fptosi float %sub_tmp to i32
  %call_tmp4 = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 %1)
  %mul_tmp = fmul float 3.000000e+00, 4.000000e+00
  %2 = fptosi float %mul_tmp to i32
  %call_tmp7 = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 %2)
  %div_tmp = fdiv float 3.000000e+00, 4.000000e+00
  %3 = fptosi float %div_tmp to i32
  %call_tmp10 = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 %3)
