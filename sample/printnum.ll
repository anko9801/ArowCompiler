...
define i32 @main() {
entry:
  %call_tmp = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 1)
  %call_tmp1 = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 3)
  %call_tmp2 = call i1 bitcast (i32 (i32)* @printnum to i1 (i32)*)(i32 3)
  ret i32 0
}
