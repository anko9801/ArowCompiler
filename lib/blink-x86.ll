...
@.str.1 = private unnamed_addr constant [7 x i8] c"%d %x\0A\00", align 1
...
define i32 @MapGPIO() local_unnamed_addr #0 {
  %1 = tail call i32 (i8*, i32, ...) @"\01_open"(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 130) #3
  store i32 %1, i32* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 1), align 8, !tbaa !3
  %2 = load i64, i64* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 0), align 8, !tbaa !10
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i64 8, i64 %2)
  %4 = load i32, i32* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 1), align 8, !tbaa !3
  %5 = load i64, i64* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 0), align 8, !tbaa !10
  %6 = tail call i8* @"\01_mmap"(i8* null, i64 4096, i32 3, i32 1, i32 %4, i64 %5) #3
...
; <label>:8:                                      ; preds = %0
  tail call void @perror(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #4
  br label %10
...
define i32 @GPIOsetup() local_unnamed_addr #0 {
  ...
  store i32 %1, i32* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 1), align 8, !tbaa !3
  %2 = load i64, i64* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 0), align 8, !tbaa !10
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i64 8, i64 %2) #3
  %4 = load i32, i32* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 1), align 8, !tbaa !3
  %5 = load i64, i64* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 0), align 8, !tbaa !10
  %6 = tail call i8* @"\01_mmap"(i8* null, i64 4096, i32 3, i32 1, i32 %4, i64 %5) #3
  store i8* %6, i8** getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 2), align 8, !tbaa !11
...
; <label>:9:                                      ; preds = %0
  tail call void @perror(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #5
  %10 = tail call i32 @puts(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str, i64 0, i64 0))
  br label %11
...
define i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 @GPIOsetup()
  tail call void @BlinkLED(i32 23)
  %2 = load i8*, i8** getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 2), align 8, !tbaa !11
  %3 = tail call i32 @"\01_munmap"(i8* %2, i64 4096) #3
  %4 = load i32, i32* getelementptr inbounds (%struct.rpi_gpio, %struct.rpi_gpio* @gpio, i64 0, i32 1), align 8, !tbaa !3
  %5 = tail call i32 @"\01_close"(i32 %4) #3
  ret i32 0
}
